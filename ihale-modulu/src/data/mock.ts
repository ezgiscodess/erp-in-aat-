...
export const criticalTerms: CriticalTerm[] = [
  {
    ...
    action: 'Banka limiti teyit edildi, mektup hazırlanıyor', owner: 'Finans', state: 'Kontrol Ediliyor', docId: 'D1',
  ...
  },
  {
    ...
    action: 'Ek limit talebi bankaya iletildi', owner: 'Finans', state: 'Devam Ediyor', docId: 'D1',
  ...
  },
  {
    ...
    action: 'Zeyilname ile %10’a indirilmesi talep edilecek', owner: 'Teklif', state: 'Devam Ediyor', docId: 'D1',
  ...
  },
  {
    ...
    action: 'Nakit akışı 90 güne göre revize edildi', owner: 'Finans', state: 'Kontrol Ediliyor', docId: 'D2',
  ...
  },
  {
    ...
    action: 'Kredi ön onayı alındı', owner: 'Finans', state: 'Kontrol Edildi', docId: 'D1',
  ...
  },
  {
    ...
    action: 'Adana + Bandırma belgeleri birleştirilecek; iş ortaklığı değerlendiriliyor', owner: 'PMO', state: 'Kontrol Ediliyor', docId: 'D1',
  ...
  },
  {
    ...
    action: 'Teklife eskalasyon karşılığı eklendi (%6,5)', owner: 'Teklif', state: 'Etkisi Sıfırlandı', docId: 'D2',
  ...
  },
  {
    ...
    action: 'Açıklama talebi soru listesine eklendi', owner: 'PMO', state: 'Kontrol Ediliyor', docId: 'D1',
  ...
  },
  {
    ...
    action: 'Broker teklifi alındı', owner: 'Finans', state: 'Kontrol Edildi', docId: 'D2',
  ...
  },
  {
    ...
    action: 'Maliyete yansıtıldı', owner: 'Teklif', state: 'Etkisi Sıfırlandı', docId: 'D2',
  ...
  },
  {
    ...
    action: 'Tedarik planı kontrol ediliyor', owner: 'Satınalma', state: 'Kontrol Ediliyor', docId: 'D1',
  ...
  },
  {
    ...
    action: 'Pilot ortak biz olacağız', owner: 'C-Suite', state: 'Kontrol Edildi', docId: 'D1',
...
/**
 * Kontrat (sözleşme dönemi) riskleri — teklif riskleriyle aynı yapıda tutulur.
 * Fark: teklif riskleri teklif hazırlanırken fiyata yansıtılır; bunlar iş yürürken,
 * uzun dönemde ortaya çıkar (hak talebi, fiyat farkı talebi, bildirim süreleri, teminat…).
 * Her risk bir sözleşme maddesine bağlıdır; kaynak panelinde o madde açılır.
 */
export const contractRisks: BidRisk[] = [
  {
    id: 'K1', category: 'Hak talebi', title: 'Hak talebinin bildirim süresinde düşmesi',
    description: 'Olayı fark ettikten sonra 28 gün içinde bildirim yapılmazsa ek süre ve ek ödeme hakkı tamamen düşer.',
    probability: 3, impact: 5, costImpact: 1_120_000, timeImpact: 0, timeBar: '28 gün',
    basis: 'Beklenen hak talepleri ≈ 3,2 M EUR × süre kaçırma oranı %35',
    basisRef: 'Özel Ş. 20.1', clauseId: 'C2',
    mitigation: 'Olay kaydı açıldığında 28 günlük otomatik geri sayım; şantiye şefine haftalık bildirim listesi',
    owner: 'PMO', state: 'Açık', provision: 0, inBid: false,
  },
  {
    id: 'K2', category: 'Fiyat farkı', title: 'Fiyat farkı talep edilememesi',
    description: 'Fiyat ayarlama maddesi silinmiş. Teklifteki eskalasyon karşılığını aşan artış iş boyunca talep edilemez.',
    probability: 4, impact: 4, costImpact: 2_420_000, timeImpact: 0,
    basis: 'Malzeme payı 44 M EUR × (%12 beklenen artış − %6,5 teklif karşılığı)',
    basisRef: 'Özel Ş. 13.8 · Teklif Riskleri R1', clauseId: 'C3',
    mitigation: 'Ana malzemelerde fiyat kilidi; artış %15’i aşarsa hardship (aşırı ifa güçlüğü) bildirimi',
    owner: 'Teklif', state: 'Açık', provision: 500_000, inBid: true,
  },
  {
    id: 'K3', category: 'Hak talebi', title: 'Sözlü talimattan doğan ek işin kaybedilmesi',
    description: 'Sözlü talimat 48 saat içinde yazılı teyit edilmezse verilmemiş sayılır; o talimatla yapılan ek iş ödenmez.',
    probability: 4, impact: 3, costImpact: 600_000, timeImpact: 0, timeBar: '48 saat',
    basis: 'Yılda ~12 sözlü talimat × ortalama 50 bin EUR ek iş',
    basisRef: 'Özel Ş. 3.3 (c)', clauseId: 'C1',
    mitigation: 'Saha talimat formu ve 48 saatlik teyit akışı; teyitsiz talimatla iş başlatılmaz',
    owner: 'PMO', state: 'İzleniyor', provision: 0, inBid: false,
  },
  {
    id: 'K4', category: 'Ödeme', title: 'Hakediş ödemelerinin 90 güne uzaması',
    description: 'Ödeme süresi 90 gün; İdari Şartname 60 gün diyor. Uygulamada 90 gün esas alınırsa iş boyunca nakit yükü sürer.',
    probability: 4, impact: 4, costImpact: 1_250_000, timeImpact: 0,
    basis: 'Ortalama 3,4 M EUR/ay hakediş × 30 gün ek gecikme × %11 kredi maliyeti × 24 ay',
    basisRef: 'Özel Ş. 14.7 ↔ İdari Ş. 32.2', clauseId: 'C4',
    mitigation: 'Çelişki için yazılı açıklama; gecikme faizi (14.8) talebinin sözleşmeye yazılması',
    owner: 'Finans', state: 'Açık', provision: 400_000, inBid: true,
  },
  {
    id: 'K5', category: 'Hak talebi', title: 'Öngörülemeyen zemin koşulu talebi',
    description: 'Madde korunmuş; ancak talep 28 günlük bildirime bağlı ve zemin etüdünün kapsamadığı bölgede ispat yükü bizde.',
    probability: 3, impact: 4, costImpact: 1_900_000, timeImpact: 35, timeBar: '28 gün',
    basis: 'Doğu uç kazık boyu artışı 16,2 M EUR × %12',
    basisRef: 'Özel Ş. 4.12 · Zemin Etüt Raporu', clauseId: 'C5',
    mitigation: 'Çakım kayıtlarının günlük tutulması; sapma görüldüğü gün bildirim',
    owner: 'Teknik', state: 'İzleniyor', provision: 0, inBid: false,
  },
  {
    id: 'K6', category: 'Süre', title: 'İşin uzaması — hava koşulu eşiği',
    description: 'Süre uzatımı için “olağandışı hava” eşiği 10 yıllık ortalamaya bağlı. Normal kış duraklamaları süre uzatımı getirmez.',
    probability: 3, impact: 3, costImpact: 740_000, timeImpact: 30,
    basis: 'Deniz ekipmanı kirası 370 bin EUR/ay × 2 ay eşiğin altında kalan duraklama',
    basisRef: 'Özel Ş. 8.4', clauseId: 'C6',
    mitigation: 'Meteoroloji istasyonu kayıtlarının aylık arşivlenmesi; eşik aşımında aynı hafta bildirim',
    owner: 'PMO', state: 'Açık', provision: 200_000, inBid: true,
  },
  {
    id: 'K7', category: 'Teminat', title: 'Kesin teminatın 730 gün bloke kalması',
    description: 'Kusur sorumluluğu süresi 365 yerine 730 gün. Kesin teminat iki yıl daha banka limitini bağlar.',
    probability: 5, impact: 2, costImpact: 250_000, timeImpact: 0,
    basis: '4,92 M EUR teminat × %2,5 yıllık komisyon × 2 yıl',
    basisRef: 'Özel Ş. 11.1', clauseId: 'C7',
    mitigation: 'Geçici kabulde teminatın yarısının iadesi talebi',
    owner: 'Finans', state: 'Açık', provision: 250_000, inBid: true,
  },
  {
    id: 'K8', category: 'Sorumluluk', title: 'Sorumluluk sınırının sözleşme bedeli kadar olması',
    description: 'Toplam sorumluluk sınırı sözleşme bedelinin %100’ü; dolaylı zarar istisnası daraltılmış.',
    probability: 1, impact: 5, costImpact: 0, timeImpact: 0,
    basis: 'Bedel etkisi yok — sigorta kapsamıyla birlikte değerlendirilir',
    basisRef: 'Özel Ş. 17.6', clauseId: 'C8',
    mitigation: 'Sınırın %50’ye indirilmesi revizyon talebi; mesleki sorumluluk sigortası',
    owner: 'C-Suite', state: 'Açık', provision: 0, inBid: false,
  },
  {
    id: 'K9', category: 'Fesih', title: 'İşverenin takdire bağlı fesih hakkı',
    description: 'Fesih sebeplerine “İdare’nin uygun göreceği diğer hâller” eklenmiş. Mobilizasyon ve tedarik maliyetleri açıkta kalabilir.',
    probability: 1, impact: 5, costImpact: 1_600_000, timeImpact: 0,
    basis: 'Mobilizasyon + ödenmemiş kazık siparişi ≈ 1,6 M EUR',
    basisRef: 'Özel Ş. 15.2', clauseId: 'C9',
    mitigation: 'Keyfi fesihte kâr kaybı ve demobilizasyon bedelinin ödenmesi şartı',
    owner: 'C-Suite', state: 'İzleniyor', provision: 0, inBid: false,
  },
  {
    id: 'K10', category: 'Uyuşmazlık', title: 'Tahkim maliyeti ve süresi',
    description: 'ICC tahkimi İstanbul’da; uyuşmazlık hâlinde 18–24 aylık süreç ve yüksek masraf.',
    probability: 2, impact: 3, costImpact: 350_000, timeImpact: 0,
    basis: 'ICC idari ücret + hakem ücretleri + hukuk danışmanlığı tahmini',
    basisRef: 'Özel Ş. 20.6', clauseId: 'C10',
    mitigation: 'Uyuşmazlık kurulunun (DAB) iş başında kurulması; kayıtların talebe hazır tutulması',
    owner: 'Hukuk', state: 'Açık', provision: 0, inBid: false,
  },
]
