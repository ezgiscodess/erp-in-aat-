  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        ...
        <Kpi label="Kriter" value={goNoGoCriteria.length} sub={`${groups.length} grupta ağırlıklandırıldı`}
          help="Karara giren kriter sayısı. Ağırlıklar şirketin ihale politikasına göre bir kez tanımlanır." />
      ...
      {/* Üst sıra: solda sonuç, sağda kriter grupları */}
      ...
      {/* Alt sıra: solda kriter tablosu, sağda şartlı GO koşulları */}
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
        ...
        <div className="lg:col-span-4">
          <Card title="Şartlı GO koşulları" help="Teklife girilmesi için karşılanması gereken koşullar. Karşılanmazsa karar No-Go’ya döner.">
            ...
            <p className="mt-2 text-[11.5px] text-[var(--faint)]">
              Onay yetkisi üst yönetimdedir; karar ve gerekçesi kayıt altına alınır.
            </p>
          </Card>
        </div>
      </div>
